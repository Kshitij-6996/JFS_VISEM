function showInventor() {
    ...
    const inventorImage = document.getElementById("inventorImage");
    ...
    if (inventor === "") {
        inventorImage.src = "";
        inventorImage.className = "circle-image";
        document.getElementById("infoBox").innerText = "Select an inventor to view details";
    } else {
        inventorImage.src = data[inventor].img;
        // Set image to square for James Gosling, circle for all others
        if (inventor === "gosling") {
            inventorImage.className = "square-image";
        } else {
            inventorImage.className = "circle-image";
        }
